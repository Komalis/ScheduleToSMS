...
*   Dans un premier temps, elle enverra l'emploi du temps entier par SMS 5 minutes avant le début du premier cours. (Paramétrable).
*   Dans un second temps, elle enverra 5 minutes avant le prochain cours un SMS informant l'Utilisateur du nom du cours, du type de cours, de la salle, du professeur, ainsi que la durée.
